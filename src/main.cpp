...
void LoadTestModel() {
    ...
    const aiScene* scene = importer.ReadFile(RESOURCES_PATH "../assets/Untitled.obj", 
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("light.diffuse", 0.1f, 0.5f, 0.1f);
        lightingShader.setVec3("light.specular", 0.0f, 1.0f, 0.0f);
        lightingShader.setFloat("light.constant", 1.0f);
        lightingShader.setFloat("light.linear", 0.09f);
        lightingShader.setFloat("light.quadratic", 0.032f);
        lightingShader.setFloat("light.cutOff",12.5);
        lightingShader.setFloat("light.outerCutOff",17.5);
